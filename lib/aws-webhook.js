 ...
 * Calls the AWS API to retrieve all channel-category mappings
 */
awsWebhook.getMappings = async () => {
	const settings = await getSettings();
 ...
 */
awsWebhook.saveMapping = async ({ channelId, channelName, categoryId, categorySlug }) => {
	const settings = await getSettings();
